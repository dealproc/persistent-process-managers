...
public sealed partial class ContactEditorViewModel : ViewModelBase, IContactEditorViewModel {
    ...
    public void Edit(Domains.ErpApp.ContactCollection.ContactDetails contact) {
    ...
    private async Task AddOrUpdate() {
        ICommand cmd = _isEditingContact
            ? MessageBuilder.New(() => new Domains.ErpApp.ContactMsgs.UpdateDetails(
                _contactId,
                FirstName,
                LastName,
                Email))
...
public interface IContactEditorViewModel : IRoutableViewModel {
    ...
    void Edit(Domains.ErpApp.ContactCollection.ContactDetails contact);
}
